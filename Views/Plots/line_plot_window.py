...
class Ui_MainWindow_Line_Plot(object):
    def setupUi(self, MainWindow_Line_Plot):
        ...
        MainWindow_Line_Plot.resize(1200, 850)
        MainWindow_Line_Plot.setMinimumSize(QtCore.QSize(1200, 850))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 383, 828))
    ...
    def retranslateUi(self, MainWindow_Line_Plot):
        ...
        self.comboBox_Hue.setPlaceholderText(
            _translate("MainWindow_Line_Plot", "Wybierz dane według, których grupować..."))
        ...
        self.comboBox_Legend.setPlaceholderText(
            _translate("MainWindow_Line_Plot", "Wybierz opcje wyświetlania legendy..."))
