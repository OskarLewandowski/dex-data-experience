...
class Ui_MainWindow_Pie_Plot(object):
    ...
    def retranslateUi(self, MainWindow_Pie_Plot):
        ...
        self.label.setText(_translate("MainWindow_Pie_Plot", "Zbiór danych:"))
        ...
        self.label_2.setText(_translate("MainWindow_Pie_Plot", "Oś X:"))
        self.toolButton_X.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_X.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz dane na osi x..."))
        self.label_3.setText(_translate("MainWindow_Pie_Plot", "Oś Y:"))
        self.toolButton_Y.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Y.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz dane na osi y..."))
        self.label_4.setText(_translate("MainWindow_Pie_Plot", "Grupowanie:"))
        self.toolButton_Hue.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Hue.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz dane według, których grupować..."))
        self.label_5.setText(_translate("MainWindow_Pie_Plot", "Rozmiar punktów:"))
        self.toolButton_Size.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Size.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz dane według, których ustalić rozmiar punktów..."))
        self.label_6.setText(_translate("MainWindow_Pie_Plot", "Styl punktów:"))
        self.toolButton_Style.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Style.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz styl punktów..."))
        ...
        self.label_7.setText(_translate("MainWindow_Pie_Plot", "Kształt punktów:"))
        self.toolButton_Markers.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Markers.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz kształt punktów..."))
        self.comboBox_Markers.setItemText(0, _translate("MainWindow_Pie_Plot", "."))
        self.comboBox_Markers.setItemText(1, _translate("MainWindow_Pie_Plot", ","))
        self.comboBox_Markers.setItemText(2, _translate("MainWindow_Pie_Plot", "o"))
        self.comboBox_Markers.setItemText(3, _translate("MainWindow_Pie_Plot", "v"))
        self.comboBox_Markers.setItemText(4, _translate("MainWindow_Pie_Plot", "^"))
        self.comboBox_Markers.setItemText(5, _translate("MainWindow_Pie_Plot", ">"))
        self.comboBox_Markers.setItemText(6, _translate("MainWindow_Pie_Plot", "<"))
        self.comboBox_Markers.setItemText(7, _translate("MainWindow_Pie_Plot", "+"))
        self.comboBox_Markers.setItemText(8, _translate("MainWindow_Pie_Plot", "x"))
        self.comboBox_Markers.setItemText(9, _translate("MainWindow_Pie_Plot", "s"))
        self.comboBox_Markers.setItemText(10, _translate("MainWindow_Pie_Plot", "D"))
        self.comboBox_Markers.setItemText(11, _translate("MainWindow_Pie_Plot", "-"))
        self.comboBox_Markers.setItemText(12, _translate("MainWindow_Pie_Plot", "--"))
        self.comboBox_Markers.setItemText(13, _translate("MainWindow_Pie_Plot", "|"))
        self.comboBox_Markers.setItemText(14, _translate("MainWindow_Pie_Plot", ":"))
        self.comboBox_Markers.setItemText(15, _translate("MainWindow_Pie_Plot", "*"))
        self.comboBox_Markers.setItemText(16, _translate("MainWindow_Pie_Plot", "H"))
        self.comboBox_Markers.setItemText(17, _translate("MainWindow_Pie_Plot", "X"))
        self.label_8.setText(_translate("MainWindow_Pie_Plot", "Legenda:"))
        self.toolButton_Legend.setText(_translate("MainWindow_Pie_Plot", "X"))
        self.comboBox_Legend.setPlaceholderText(_translate("MainWindow_Pie_Plot", "Wybierz opcje wyświetlania legendy..."))
        self.comboBox_Legend.setItemText(0, _translate("MainWindow_Pie_Plot", "auto"))
        self.comboBox_Legend.setItemText(1, _translate("MainWindow_Pie_Plot", "brief"))
        self.comboBox_Legend.setItemText(2, _translate("MainWindow_Pie_Plot", "full"))
        self.comboBox_Legend.setItemText(3, _translate("MainWindow_Pie_Plot", "Brak"))
