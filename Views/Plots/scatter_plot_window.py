...
class Ui_MainWindow_Scatter_Plot(object):
    def setupUi(self, MainWindow_Scatter_Plot):
        ...
        MainWindow_Scatter_Plot.resize(1200, 850)
        MainWindow_Scatter_Plot.setMinimumSize(QtCore.QSize(1200, 850))
    ...
    def retranslateUi(self, MainWindow_Scatter_Plot):
        ...
        self.comboBox_Markers.setItemText(13, _translate("MainWindow_Scatter_Plot", "H"))
        self.comboBox_Markers.setItemText(14, _translate("MainWindow_Scatter_Plot", "X"))
