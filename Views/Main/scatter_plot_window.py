...
class Ui_MainWindow_Scatter_Plot(object):
    def setupUi(self, MainWindow_Scatter_Plot):
        ...
        self.toolButton_Data.clicked.connect(self.comboBox_Data.clear) # type: ignore
        self.toolButton_X.clicked.connect(self.comboBox_X.clear) # type: ignore
        self.toolButton_Y.clicked.connect(self.comboBox_Y.clear) # type: ignore
        self.toolButton_Hue.clicked.connect(self.comboBox_Hue.clear) # type: ignore
        self.toolButton_Title_Plot.clicked.connect(self.lineEdit_Title_Plot.clear) # type: ignore
        self.toolButton_Style.clicked.connect(self.comboBox_Style.clear) # type: ignore
        self.toolButton_Size.clicked.connect(self.comboBox_Size.clear) # type: ignore
        self.toolButton_Markers.clicked.connect(self.comboBox_Markers.clear) # type: ignore
        self.toolButton_Label_X.clicked.connect(self.lineEdit_Label_X.clear) # type: ignore
        self.toolButton_Legend.clicked.connect(self.comboBox_Legend.clear) # type: ignore
