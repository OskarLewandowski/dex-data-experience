...
class Ui_MainWindow_Main(object):
    def setupUi(self, MainWindow_Main):
        ...
        self.menu_Normality_Tests = QtWidgets.QMenu(parent=self.menu_Analysis)
        self.menu_Normality_Tests.setObjectName("menu_Normality_Tests")
        self.menu_Correlation = QtWidgets.QMenu(parent=self.menu_Analysis)
        self.menu_Correlation.setObjectName("menu_Correlation")
        self.menu_Tests_T_Student = QtWidgets.QMenu(parent=self.menu_Analysis)
        self.menu_Tests_T_Student.setObjectName("menu_Tests_T_Student")
        ...
        self.menu_Guide = QtWidgets.QMenu(parent=self.menubar_Menu)
        self.menu_Guide.setObjectName("menu_Guide")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/main-window/open-file.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/main-window/save-file.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Save.setIcon(icon2)
        self.action_Save.setObjectName("action_Save")
        self.action_Print = QtGui.QAction(parent=MainWindow_Main)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/main-window/print.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/main-window/export-pdf.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Export_As.setIcon(icon4)
        self.action_Export_As.setObjectName("action_Export_As")
        self.action_Exit = QtGui.QAction(parent=MainWindow_Main)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/main-window/exit-red.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Exit.setIcon(icon5)
        self.action_Exit.setObjectName("action_Exit")
        self.action_Undo = QtGui.QAction(parent=MainWindow_Main)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/main-window/undo-transparent.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Undo.setIcon(icon6)
        self.action_Undo.setObjectName("action_Undo")
        self.action_Redo = QtGui.QAction(parent=MainWindow_Main)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/main-window/redo-transparent.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/main-window/add-data.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Add_Data.setIcon(icon8)
        self.action_Add_Data.setObjectName("action_Add_Data")
        self.action_Modify_Data = QtGui.QAction(parent=MainWindow_Main)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/main-window/data-processing-1.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        self.action_Modify_Data.setIcon(icon9)
        self.action_Modify_Data.setObjectName("action_Modify_Data")
        self.action_Bold = QtGui.QAction(parent=MainWindow_Main)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/images/main-window/bold.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Bold.setIcon(icon10)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/images/main-window/underline.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_Underline.setIcon(icon12)
        self.action_Underline.setObjectName("action_Underline")
        self.action_Left = QtGui.QAction(parent=MainWindow_Main)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/images/main-window/text-left.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_Left.setIcon(icon13)
        self.action_Left.setObjectName("action_Left")
        self.action_Right = QtGui.QAction(parent=MainWindow_Main)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/images/main-window/text-right.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_Right.setIcon(icon14)
        self.action_Right.setObjectName("action_Right")
        self.action_Center = QtGui.QAction(parent=MainWindow_Main)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/images/main-window/text-center.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_Center.setIcon(icon15)
        self.action_Center.setObjectName("action_Center")
        self.action_Justify = QtGui.QAction(parent=MainWindow_Main)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/images/main-window/text-justify.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_Justify.setIcon(icon16)
        self.action_Justify.setObjectName("action_Justify")
        self.action_About_Application = QtGui.QAction(parent=MainWindow_Main)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/images/main-window/mw-help.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        self.action_About_Application.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/images/main-window/mw-settings.svg"), QtGui.QIcon.Mode.Normal,
                         QtGui.QIcon.State.Off)
        ...
        self.action_Scatter_Plot = QtGui.QAction(parent=MainWindow_Main)
        self.action_Scatter_Plot.setObjectName("action_Scatter_Plot")
        self.action_Line_Plot = QtGui.QAction(parent=MainWindow_Main)
        self.action_Line_Plot.setObjectName("action_Line_Plot")
        self.action_Bar_Plot = QtGui.QAction(parent=MainWindow_Main)
        self.action_Bar_Plot.setObjectName("action_Bar_Plot")
        self.action_Hist_Plot = QtGui.QAction(parent=MainWindow_Main)
        self.action_Hist_Plot.setObjectName("action_Hist_Plot")
        self.action_Box_Plot = QtGui.QAction(parent=MainWindow_Main)
        ...
        self.action_Test_T_Student_For_Two_Independent_Samples = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_T_Student_For_Two_Independent_Samples.setObjectName(
            "action_Test_T_Student_For_Two_Independent_Samples")
        self.action_Test_ANOVA = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_ANOVA.setObjectName("action_Test_ANOVA")
        self.action_Test_Chi_Square = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_Chi_Square.setObjectName("action_Test_Chi_Square")
        self.action_Test_Kruskala_Wallisa = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_Kruskala_Wallisa.setObjectName("action_Test_Kruskala_Wallisa")
        self.action_Test_Shapiro_Wilka = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_Shapiro_Wilka.setObjectName("action_Test_Shapiro_Wilka")
        self.action_Test_Andersona_Darlinga = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_Andersona_Darlinga.setObjectName("action_Test_Andersona_Darlinga")
        self.action_Test_Kolmogorova_Smirnova = QtGui.QAction(parent=MainWindow_Main)
        self.action_Test_Kolmogorova_Smirnova.setObjectName("action_Test_Kolmogorova_Smirnova")
        self.action_Test_Lillieforsa = QtGui.QAction(parent=MainWindow_Main)
        ...
        self.action_Pearson_Correlation = QtGui.QAction(parent=MainWindow_Main)
        self.action_Pearson_Correlation.setObjectName("action_Pearson_Correlation")
        self.action_Spearman_Correlation = QtGui.QAction(parent=MainWindow_Main)
        self.action_Spearman_Correlation.setObjectName("action_Spearman_Correlation")
        self.action_Kendall_Correlation = QtGui.QAction(parent=MainWindow_Main)
        self.action_Kendall_Correlation.setObjectName("action_Kendall_Correlation")
        self.action_Distribution_Series = QtGui.QAction(parent=MainWindow_Main)
        ...
        self.menu_Data.addAction(self.action_Data_Preview)
        ...
        self.menu_Normality_Tests.addAction(self.action_Test_Shapiro_Wilka)
        self.menu_Normality_Tests.addAction(self.action_Test_Andersona_Darlinga)
        self.menu_Normality_Tests.addAction(self.action_Test_Kolmogorova_Smirnova)
        self.menu_Normality_Tests.addAction(self.action_Test_Lillieforsa)
        self.menu_Normality_Tests.addAction(self.action_Test_Jarque_Bera)
        self.menu_Correlation.addAction(self.action_Pearson_Correlation)
        self.menu_Correlation.addAction(self.action_Spearman_Correlation)
        self.menu_Correlation.addAction(self.action_Kendall_Correlation)
        ...
        self.menu_Analysis.addAction(self.menu_Correlation.menuAction())
        self.menu_Analysis.addAction(self.menu_Tests_T_Student.menuAction())
        ...
        self.menu_Charts.addAction(self.action_Hist_Plot)
        self.menu_Charts.addAction(self.action_Box_Plot)
        self.menu_Charts.addAction(self.action_Pie_Chart)
        ...
        self.menu_Guide.addAction(self.action_Guide)
        ...
        self.menubar_Menu.addAction(self.menu_Guide.menuAction())
    ...
    def retranslateUi(self, MainWindow_Main):
        ...
        self.menu_Guide.setTitle(_translate("MainWindow_Main", "Przewodnik"))
        ...
        self.action_Scatter_Plot.setText(_translate("MainWindow_Main", "Punktowy"))
        self.action_Line_Plot.setText(_translate("MainWindow_Main", "Liniowy"))
        self.action_Bar_Plot.setText(_translate("MainWindow_Main", "Słupkowy"))
        ...
        self.action_Test_Andersona_Darlinga.setText(_translate("MainWindow_Main", "Test Andersona-Darlinga"))
        ...
        self.action_Pearson_Correlation.setText(_translate("MainWindow_Main", "Korelacja Pearsona"))
        self.action_Spearman_Correlation.setText(_translate("MainWindow_Main", "Korelacja Spearmana"))
