...
class Ui_Dialog_Search(object):
    def setupUi(self, Dialog_Search):
        ...
        Dialog_Search.resize(555, 125)
        Dialog_Search.setMinimumSize(QtCore.QSize(555, 125))
        Dialog_Search.setMaximumSize(QtCore.QSize(555, 125))
        icon = QtGui.QIcon()
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(Dialog_Search)
